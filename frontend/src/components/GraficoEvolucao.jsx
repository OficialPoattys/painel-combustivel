    ...
    <div className="card grafico-card">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <LineChart data={data} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
          ...
          <XAxis dataKey="semana" tick={{ fontSize: 10, fill: '#868E96', fontFamily: 'var(--font-mono)' }} tickLine={false} axisLine={{ stroke: '#DEE2E6' }} />
          <YAxis domain={[parseFloat(yMin), parseFloat(yMax)]} tickFormatter={v => `R$${v.toFixed(2)}`} tick={{ fontSize: 10, fill: '#868E96', fontFamily: 'var(--font-mono)' }} width={65} />
